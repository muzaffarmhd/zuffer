  ...
  useEffect(() => {
    ...
    const vertexShader = `
      ...
      void main() {
        ...
        float displacement = cnoise(0.4 * position + vec3(0.0, speed * time, 0.0)) * noise_elevation;
        displacement += cnoise(2.0 * position + vec3(0.0, speed * time * 5.0, 0.0)) * 0.3 * noise_elevation;
        displacement += cnoise(8.0 * position + vec3(0.0, speed * time * 20.0, 0.0)) * 0.1 * noise_elevation;

        displacement = displacement + (sin(position.x / 2.0 - 3.14159 / 2.0)) * valley_elevation;
    ...
    const fragmentShader = `
      ...
      void main() {
        float alpha = sin(v_uv.y * 3.14159) / 4.0;
